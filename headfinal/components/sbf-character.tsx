...
export default function SBFCharacter({ isKicking, direction, priority = false, style = {} }: SBFCharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main SBF character with larger size and head */}
      <div
