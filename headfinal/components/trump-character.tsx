...
export default function TrumpCharacter({ isKicking, direction, priority = false, style = {} }: TrumpCharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main Trump character with larger size and head */}
      <div
      ...
      >
        <Image
          src="/images/trump-character.png"
          alt="Trump Character"
          fill
          style={{
            objectFit: "contain",
