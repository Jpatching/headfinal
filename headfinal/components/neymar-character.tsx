...
interface NeymarCharacterProps {
  isKicking: boolean
...
export default function NeymarCharacter({ isKicking, direction, priority = false, style = {} }: NeymarCharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main Neymar character with larger size and head */}
      <div
      ...
      >
        <Image
          src="/images/neymar-character.png"
          alt="Neymar Character"
          fill
          style={{
            objectFit: "contain",
