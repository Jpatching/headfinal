...
export default function PessiCharacter({ isKicking, direction, priority = false, style = {} }: PessiCharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main Pessi character with larger size and head */}
      <div
      ...
      >
        <Image
          src="/images/pessi-character.png"
          alt="Pessi Character"
          fill
          style={{
            objectFit: "contain",
