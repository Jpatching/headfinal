...
export default function CR7Character({ isKicking, direction, priority = false, style = {} }: CR7CharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main CR7 character with larger size and head */}
      <div
