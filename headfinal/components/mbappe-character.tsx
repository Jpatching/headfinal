...
interface MbappeCharacterProps {
  isKicking: boolean
...
export default function MbappeCharacter({ isKicking, direction, priority = false, style = {} }: MbappeCharacterProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Main Mbappe character with larger size and head */}
      <div
      ...
      >
        <Image
          src="/images/mbappe-character.png"
          alt="Mbappe Character"
          fill
          style={{
            objectFit: "contain",
